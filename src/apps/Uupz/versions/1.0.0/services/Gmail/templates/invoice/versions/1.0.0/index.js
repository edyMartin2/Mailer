...
module.exports = Template = (email, template) => {
    ...
    var tBody_DatosFiscales = '',
        tBody_DatosFacturacion = '';
    // Iteración dinámica de datos para la construcción del contenido de la Tabla - Datos del Contacto
    Object.entries(content.dataTax).forEach(([key, value]) => {
    ...
    Object.entries(content.dataInvoice).forEach(([key, value]) => {
                                            ...
                                            <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing: 0; border-left: 1px solid #e8e7e5; border-right: 1px solid #e8e7e5; border-bottom: 1px solid #e8e7e5; border-radius: 15px;" bgcolor="#FFFFFF">
                                                <tr>
                                                    <td align="justify" style="padding: 20px;">
                                                        ...
                                                        <p style="color: #121212; font-size: 12px; text-align: justify; font-family: Verdana, Geneva, sans-serif; padding: 0 !important; margin: 0 !important; line-height: 20px;">Estimado <b><i>` + content.dataTax["Razón Social"] + `</i></b>, ` + content.dataSubject["Descripción"].toLowerCase() + `</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="padding: 20px;">
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    <th colspan="2"><p style="color: #262626; font-size: 18px; text-align: center; font-family: Verdana, Geneva, sans-serif; margin: 0 !important;">Datos Fiscales</p></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>` + tBody_DatosFiscales + `</tbody>
                                                        </table>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="padding: 20px;">
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    <th colspan="2"><p style="color: #262626; font-size: 18px; text-align: center; font-family: Verdana, Geneva, sans-serif; margin: 0 !important;">Detalles de Facturación</p></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>` + tBody_DatosFacturacion + `</tbody>
                                                        </table>
                                                    </td>
                                                </tr>
                                            </table>
                                                            ...
                                                            <table class="contents" style="border-spacing: 0; width: 100%;">
                                                                ...
                                                                <tr>
                                                                    <td align="center" style="padding-top: 0; padding-bottom: 0; padding-right: 0; padding-left: 0;">
                                                                        <p style="color: #262626; font-size: 12px; text-align: center; font-family: Verdana, Geneva, sans-serif; padding: 0 !important;"><b>Todos los derechos reservados © ` + new Date().getFullYear() + `</b></p>
