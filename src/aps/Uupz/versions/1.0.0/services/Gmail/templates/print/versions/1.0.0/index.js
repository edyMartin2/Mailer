...
module.exports = Template = (email, template) => {
    ...
    Object.entries(content.dataDetails).forEach(([key, value]) => {
                                                ...
                                                <tr>
                                                    <td align="center" style="padding: 20px;">
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    <th colspan="2"><p style="color: #262626; font-size: 18px; text-align: center; font-family: Verdana, Geneva, sans-serif; margin: 0 !important;">` + ((content.dataContact["Nombre"] !== undefined) ? ("Detalles del Mensaje") : ("Message Details")) + `</p></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>` + tBody_DetallesMensaje + `</tbody>
                                                        </table>
                                                    </td>
                                                </tr>
                                            </table>
