...
module.exports = Template = (email, template) => {
    ...
    Object.entries(content.dataBusiness).forEach(([key, value]) => {
                                            ...
                                            <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing: 0; border-left: 1px solid #e8e7e5; border-right: 1px solid #e8e7e5; border-bottom: 1px solid #e8e7e5; border-radius: 15px;" bgcolor="#FFFFFF">
                                                <tr>
                                                    <td align="justify" style="padding: 20px;">
                                                        ...
                                                        <p style="color: #121212; font-size: 12px; text-align: justify; font-family: Verdana, Geneva, sans-serif; padding: 0 !important; margin: 0 !important; line-height: 20px;">Estimado <b><i>` + content.dataContact["Nombre"] + `</i></b>, ` + content.dataSubject["Descripción"].toLowerCase() + `</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" style="padding: 20px;">
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    <th colspan="2"><p style="color: #262626; font-size: 18px; text-align: center; font-family: Verdana, Geneva, sans-serif; margin: 0 !important;">Datos del Contacto</p></th>
                                                                </tr>
                                                            </thead>
                                                ...
                                                <tr>
                                                    <td align="center" style="padding: 20px;">
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    <th colspan="2"><p style="color: #262626; font-size: 18px; text-align: center; font-family: Verdana, Geneva, sans-serif; margin: 0 !important;">Datos de la Empresa</p></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>` + tBody_DatosEmpresa + `</tbody>
                                                        </table>
                                                    </td>
                                                </tr>
                                            </table>
