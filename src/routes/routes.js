...
/* Declaración del listado para Rutas de Acceso a la aplicación */

    /* -----> Listado de Rutas | Metódo - GET <----- */
    /* -----> End List <----- */

    /* -----> Listado de Rutas | Metódo - POST <----- */
        // Send Email
    ...
    /* -----> Listado de Rutas | Metódo - PUT <----- */
    /* -----> End List <----- */

    /* -----> Listado de Rutas | Metódo - DELETE <----- */
    /* -----> End List <----- */

/* End Script */

// Exportación Global del Script para uso externo
